...
WINDTURBINES_LIST = {
    'de_grote_geert': [CONF_WINDTURBINE_DE_GROTE_GEERT, 'De Grote Geert', 1, 'Enercon', 'E-70', "Meedhuizen", 53.27988, 6.9594, dt.datetime(2013, 1, 1)],
    'de_jonge_held': [CONF_WINDTURBINE_DE_JONGE_HELD, 'De Jonge Held', 2, 'Enercon', 'E-70', "Meedhuizen", 53.27725, 6.95859, dt.datetime(2013, 1, 1)],
    ...
    'de_boerenzwaluw': [CONF_WINDTURBINE_DE_BOERENZWALUW, 'De Boerenzwaluw', 191, 'Enercon', 'E-44', "Burum", 53.265376, 6.214152, dt.datetime(2016, 8, 1)],
    'het_vliegend_hert': [CONF_WINDTURBINE_HET_VLIEGEND_HERT, 'Het Vliegend Hert', 211, 'Lagerwey', 'L82', "Rouveen", 52.59131, 6.22014, dt.datetime(2018, 9, 15)]
}
